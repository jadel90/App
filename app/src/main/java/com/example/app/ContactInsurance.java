...
public class ContactInsurance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ContactInsurance.this, MainActivity.class); // Replace MainActivity with your home or back activity
                startActivity(intent);
                Toast.makeText(ContactInsurance.this, "FAB Clicked", Toast.LENGTH_LONG).show();
            }
        });
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || company.isEmpty() || phone.isEmpty() || message.isEmpty()) {
                    Toast.makeText(ContactInsurance.this, "Please fill out all fields.", Toast.LENGTH_LONG).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(ContactInsurance.this, "Inquiry submitted successfully.", Toast.LENGTH_LONG).show();
                            // Optionally clear the fields after submission
                            clearFormFields();
                        } else {
                            Toast.makeText(ContactInsurance.this, "Failed to submit inquiry.", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
