...
public class ContactMedical extends AppCompatActivity {
    ...
    private CollectionReference medicalInquiriesRef = db.collection("ContactMedical");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ContactMedical.this, "FAB Clicked", Toast.LENGTH_LONG).show();
            }
        });
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || phone.isEmpty() || message.isEmpty()) {
                    Toast.makeText(ContactMedical.this, "Please fill out all fields.", Toast.LENGTH_LONG).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(ContactMedical.this, "Medical inquiry submitted successfully.", Toast.LENGTH_LONG).show();
                            clearFormFields();
                        } else {
                            Toast.makeText(ContactMedical.this, "Failed to submit medical inquiry.", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
